...
const MATCH_PETS = [
  {
    ...
    reviews: [
      {
        tutor: "Carla M.",
        text: "Tutor super atencioso, cachorro lindo!",
        stars: 5,
      },
...
const NOTIFICATIONS = [
  { id: 1, icon: Heart, text: "Marina curtiu seu pet Thor", time: "agora" },
  {
    id: 2,
    icon: HeartHandshake,
    text: "Novo match com Mia!",
    time: "há 10min",
  },
  {
    id: 3,
    icon: ShoppingBag,
    text: "Filhote Golden disponível perto de você",
    time: "há 1h",
  },
  {
    id: 4,
    icon: MessageCircle,
    text: "Camila te enviou uma mensagem",
    time: "há 2h",
  },
];
