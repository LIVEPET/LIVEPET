...
const partners = [
  {
    ...
    perks: [
      ...
      "Programa de pontos PetLar",
      "Banho mensal com desconto",
    ],
    coupons: [
      {
        code: "PETLAR15",
        ...
        howTo:
          "Aplique o código no carrinho ao finalizar a compra. Válido 1x por tutor.",
      },
      {
        code: "BANHOPL",
        ...
        howTo:
          "Apresente o cupom no balcão ou agende pelo app PetLar com o código.",
      },
    ],
    ...
    coupons: [
      {
        ...
        howTo:
          "Agende pelo app, escolha 'Tenho cupom' e informe o código antes de confirmar.",
      },
      {
        code: "CHECKUP99",
        ...
        howTo:
          "Solicite no balcão da unidade. Necessário pet cadastrado no app.",
      },
    ],
  ...
  },
  {
    ...
    perks: [
      "Leva e traz grátis no bairro",
      "Tosa higiênica cortesia",
      "Hidratação premium inclusa",
    ],
    coupons: [
      {
        code: "PELOPET10",
    ...
    coupons: [
      {
        ...
        howTo:
          "Selecione o pet no app, escolha a vacina e aplique o cupom no checkout.",
      },
      {
        code: "ANTIRABICA0",
        discount: "Antirrábica grátis",
        forWhat:
          "Aplicação de antirrábica anual em pets cadastrados há +6 meses.",
        howTo:
          "Disponível para assinantes Premium. Resgate na aba 'Meus cupons'.",
      },
    ],
...
const Partnerships = () => {
  ...
  const copyCode = (code) => {
    ...
    toast({
      title: "Cupom copiado",
      description: `Use o código ${code} no checkout do parceiro.`,
    });
  };
          ...
          <div className="container relative">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="mt-4 font-display text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-5xl">
                Economize com parceiros{" "}
                <span className="italic text-primary">verificados</span>
              </h1>
              <p className="mt-3 text-muted-foreground">
                Escolha uma categoria, copie o cupom e use no parceiro. Sem
                cadastro extra, sem cobrança.
              </p>
            ...
            <div className="flex flex-wrap items-center gap-2">
              {categories.map(({ key, label, Icon }) => {
                ...
                const count =
                  key === "Todos"
                    ? partners.length
                    : partners.filter((p) => p.category === key).length;
                return (
                  <button
                    key={key}
        ...
        <section className="container pt-10">
          <div className="grid gap-3 rounded-3xl border border-border/60 bg-muted/30 p-4 sm:grid-cols-3 sm:p-5">
            <Step
              ...
              desc="Filtre por categoria e clique em Ver cupons."
            />
            <Step
              n={2}
              title="Copie o código"
              desc="Um clique copia o cupom para a área de transferência."
            />
            <Step
              n={3}
              title="Use no parceiro"
              desc="Aplique o código no checkout ou no balcão."
            />
          </div>
        </section>
              ...
              <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                {filtered.map((p) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`relative h-24 bg-gradient-to-br ${p.accent}`}
                      >
          ...
          {active && (
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  Contrato <code className="font-mono">{active.contract}</code>{" "}
                  · {active.category}
                </DialogDescription>
              </DialogHeader>
              ...
              <DialogFooter className="flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <p className="text-xs text-muted-foreground">
                  Você não paga nada agora. O cupom é aplicado no checkout do
                  parceiro.
                </p>
                <Button
                  asChild
...
const Reassure = ({ icon: Icon, title, desc }) => (
