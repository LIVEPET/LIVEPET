...
const pet = {
  ...
  health: {
    ...
    exams: [
      ...
      {
        name: "Raio-X de quadril",
        date: "20/02/2026",
        status: "Leve alteração",
      },
    ],
    recommendations: [
      ...
      parents: [
        {
          ...
          role: "Pai",
          registry: "CBKC 41200",
          titles: "Campeão Nacional 2021",
        },
        {
          name: "Luna Estrela",
          role: "Mãe",
          registry: "CBKC 39811",
          titles: "Campeã Jovem 2020",
        },
      ],
      grandparents: [
  ...
  history: [
    {
      ...
      pro: "Dra. Helena Costa",
      desc: "Estado geral excelente. Peso ideal e exames normais.",
      icon: Stethoscope,
    },
    {
      date: "10/04/2026",
      type: "Vacina",
      title: "V10 (Múltipla canina)",
      pro: "Dra. Helena Costa",
      desc: "Reforço anual aplicado. Sem reações adversas.",
      icon: Syringe,
    },
    {
      date: "02/04/2026",
      ...
      pro: "Dr. Rafael Lima",
      desc: "Órgãos sem alterações. Resultado normal.",
      icon: FlaskConical,
    },
    {
      date: "15/03/2026",
      ...
      pro: "Dr. Pedro Sá",
      desc: "Profilaxia dental sob sedação. Recuperação completa.",
      icon: Activity,
    },
    {
      date: "20/02/2026",
      type: "Exame",
      title: "Raio-X de quadril",
      pro: "Dr. Rafael Lima",
      desc: "Leve displasia identificada. Acompanhamento iniciado.",
      icon: FlaskConical,
    },
    {
      date: "15/01/2026",
      ...
      title: "Gripe canina",
      pro: "Dra. Helena Costa",
      desc: "Vacinação preventiva sazonal.",
      icon: Syringe,
    },
    {
      date: "08/12/2025",
      type: "Tratamento",
      title: "Suplementação articular",
      pro: "Dra. Helena Costa",
      desc: "Início de condroitina + glucosamina diária.",
      icon: Pill,
    },
  ],
};
...
const careNetwork = [
  {
    ...
    notes:
      "Tutora principal. Acompanha integralmente a rotina e decisões de saúde.",
  },
  {
    id: "vet",
    name: "Dra. Helena Costa",
    ...
    notes:
      "Profissional de referência para emergências clínicas e rotina veterinária.",
  },
  {
    id: "fam",
  ...
  },
  {
    ...
    timeline: [
      {
        date: "10/05/2026",
        title: "Hospedagem viagem da tutora",
        type: "Hospedagem",
      },
      {
        date: "12/03/2026",
        title: "Cuidado integral 7 dias",
        type: "Hospedagem",
      },
    ],
  ...
  },
  {
    ...
    timeline: [
      {
        date: "06/06/2026",
        title: "Passeio de 50 min — Parque Ibirapuera",
        type: "Passeio",
      },
  ...
  },
  {
    ...
    timeline: [
      {
        date: "22/05/2026",
        title: "Sessão de reforço de comandos",
        type: "Treino",
      },
                ...
                {pet.vaccines.map((v) => (
                  ...
                  >
                    ...
                    <span className="text-xs text-muted-foreground">
                      Aplicada {v.date} · Próxima {v.next}
                    </span>
                  </li>
                ))}
              </ul>
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <HealthRow
                    ...
                    label="Peso ideal"
                    value={`${pet.health.weight.current} kg · ${pet.health.weight.status}`}
                  />
                  <HealthRow
                    icon={<FlaskConical className="h-4 w-4 text-violet-600" />}
                    label="Exames atualizados"
                    value={`Último em ${pet.health.exams[0].date}`}
                  />
                  <HealthRow
                    icon={<CalendarCheck className="h-4 w-4 text-amber-600" />}
                    label="Acompanhamento vet."
                    value={`Próximo: ${pet.health.nextCheckup}`}
                  />
                </ul>
                <Button
                ...
                <div className="flex items-center gap-2 rounded-xl bg-gradient-to-br from-amber-50 to-white p-3 ring-1 ring-amber-100">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="truncate font-semibold">
                      {pet.lineage.registry}
                    </p>
                  </div>
                </div>
                <p className="text-xs text-muted-foreground">
                  Registro com {pet.lineage.generations} gerações certificadas.
                  Visualize a árvore genealógica completa.
                </p>
                <Button
      ...
      <Dialog open={healthOpen} onOpenChange={setHealthOpen}>
        <DialogContent className="max-w-2xl rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Panorama completo da condição clínica e recomendações do
              veterinário.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-5 pt-2">
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              <StatBox
                label="Índice"
                value={`${pet.health.score}`}
                sub="de 100"
              />
              <StatBox
                label="Peso"
                value={`${pet.health.weight.current}kg`}
                sub={pet.health.weight.status}
              />
              <StatBox
                label="Última consulta"
                value={pet.health.lastCheckup}
                sub="check-up"
              />
              <StatBox
                label="Próxima"
                value={pet.health.nextCheckup}
                sub="agendar"
              />
            </div>
            ...
            <div>
              <h4 className="mb-2 flex items-center gap-2 text-sm font-semibold">
                <FlaskConical className="h-4 w-4 text-violet-600" /> Exames
                recentes
              </h4>
            ...
            <div>
              <h4 className="mb-2 flex items-center gap-2 text-sm font-semibold">
                <FileText className="h-4 w-4 text-primary" /> Observações e
                recomendações
              </h4>
      ...
      <Dialog open={lineageOpen} onOpenChange={setLineageOpen}>
        <DialogContent className="max-w-4xl rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Pedigree {pet.lineage.registry} · {pet.lineage.generations}{" "}
              gerações certificadas.
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="relative overflow-x-auto rounded-2xl border bg-gradient-to-b from-muted/30 to-background p-5">
                  <div className="relative mx-auto min-w-[640px]">
                    ...
                    >
                      ...
                      <path
                        d="M12.5,18 V32 H37.5 V46"
                        className="fill-none stroke-amber-300/70"
                        strokeWidth="0.4"
                      />
                      <path
                        d="M37.5,18 V32 H37.5 V46"
                        className="fill-none stroke-amber-300/70"
                        strokeWidth="0.4"
                      />
                      <path
                        d="M62.5,18 V32 H62.5 V46"
                        className="fill-none stroke-amber-300/70"
                        strokeWidth="0.4"
                      />
                      <path
                        d="M87.5,18 V32 H62.5 V46"
                        className="fill-none stroke-amber-300/70"
                        strokeWidth="0.4"
                      />
                      {/* parents -> self (2 -> 1) */}
                      <path
                        d="M37.5,62 V76 H50 V90"
                        className="fill-none stroke-primary/50"
                        strokeWidth="0.5"
                      />
                      <path
                        d="M62.5,62 V76 H50 V90"
                        className="fill-none stroke-primary/50"
                        strokeWidth="0.5"
                      />
                    </svg>
                    ...
                    <div className="relative flex justify-center">
                      <div className="w-64">
                        <TreeNode
                          ...
                          gender="male"
                          active={
                            selectedAncestor.name === pet.lineage.tree.self.name
                          }
                          onClick={() =>
                            setSelectedAncestor({
                              name: pet.lineage.tree.self.name,
                ...
                <aside className="rounded-2xl border bg-card p-5">
                  ...
                  <div className="mt-4 space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2 rounded-lg bg-primary-soft/60 px-3 py-2 text-primary">
                      ...
                      <span className="font-medium">
                        Compatibilidade racial 98%
                      </span>
                    </div>
                  </div>

                  <p className="mt-4 text-xs text-muted-foreground">
                    Toque em qualquer ancestral da árvore para ver detalhes e
          ...
          {selectedContact && (
            <>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap gap-1.5">
                      ...
                      <Badge
                        variant="secondary"
                        className={`rounded-full text-[10px] uppercase tracking-wider ${bondTone[selectedContact.bondLevel]}`}
                      >
              ...
              <div className="space-y-5 px-6 pb-6">
                ...
                <Section
                  title="Índice de Convivência"
                  icon={<Sparkles className="h-4 w-4" />}
                >
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                    <StatBox
                      label="Tempo juntos"
                      value={selectedContact.timeTogether}
                      sub="Convivência"
                    />
                    <StatBox
                      label="Interações"
                      value={String(selectedContact.interactions)}
                      sub="Registradas"
                    />
                    <StatBox
                      label="Última"
                    ...
                    <StatBox
                      label="Frequência"
                      value={selectedContact.frequency}
                      sub="Contato"
                    />
                  </div>
                </Section>
                ...
                <Section
                  title="Histórico de Responsabilidade"
                  icon={<ShieldCheck className="h-4 w-4" />}
                >
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                    <StatBox
                      label="Vezes responsável"
                      value={String(selectedContact.timesResponsible)}
                      sub="Período total"
                    />
                    <StatBox
                      label="Dias totais"
                      value={String(selectedContact.totalDays)}
                      sub="Sob cuidados"
                    />
                    <StatBox
                      label="Maior período"
                      value={selectedContact.longestStreak}
                      sub="Consecutivo"
                    />
                    <StatBox
                      label="Última"
                      value={selectedContact.lastResponsibility}
                      sub="Responsabilidade"
                    />
                  </div>
                </Section>
                ...
                >
                  <div className="rounded-xl border bg-muted/30 p-4">
                    <div className="mb-2 flex items-center justify-between">
                      ...
                      <Badge
                        className={`rounded-full ${bondTone[selectedContact.bondLevel]}`}
                      >
                    ...
                    <p className="mt-2 text-xs text-muted-foreground">
                      Calculado a partir da frequência de contato e interações
                      registradas.
                    </p>
                  </div>
                </Section>
...
const ContactBlock = ({ label, name, phone, extra }) => (
  ...
  >
    ...
    <div className="min-w-0 flex-1">
      ...
      <div className="mt-0.5 flex items-center gap-1.5">
        <span
          className={`inline-flex items-center rounded-full px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wider ${bondTone[contact.bondLevel]}`}
        >
          {contact.bondLevel}
        </span>
