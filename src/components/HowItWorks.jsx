...
const features = [
  {
    ...
    description:
      "Certificados verificados com selo oficial e histórico de linhagem confiável.",
  ...
  },
  {
    ...
    description:
      "Identificação digital instantânea com todos os dados essenciais do seu pet.",
  ...
  },
  {
    ...
    description:
      "Histórico completo, lembretes automáticos e alertas inteligentes.",
  ...
  },
  {
    ...
    description:
      "Visualize a linhagem paterna e materna em até 3 gerações de forma interativa.",
    anim: "animate-float-y",
  },
  {
    icon: Heart,
    ...
    description:
      "Encontre o pet ideal com base em perfil, rotina e compatibilidade.",
    anim: "animate-heartbeat",
  },
  {
    icon: Users,
    ...
    description:
      "Tutores, veterinários e cuidadores conectados em torno do bem-estar do animal.",
    anim: "animate-wiggle-slow",
  },
];
    ...
    <section id="how" className="container relative py-24 sm:py-28">
      <div className="mx-auto mb-12 max-w-2xl text-center">
        ...
        <h2 className="mt-3 font-display text-3xl font-bold leading-tight text-foreground text-balance sm:text-4xl">
          Funcionalidades{" "}
          <span className="italic text-primary">essenciais</span>
        </h2>
