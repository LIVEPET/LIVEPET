    ...
    <footer className="mt-16 border-t border-border/60 bg-gradient-to-b from-secondary/30 to-secondary/60">
      <div className="container py-14">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Cuidar nunca foi tão fácil. Toda a saúde do seu pet, organizada
              com carinho.
            </p>
            <div className="flex items-center gap-2 pt-1">
              {[
                ...
                {
                  Icon: Mail,
                  href: "mailto:contato@livepet.app",
                  label: "Email",
                },
              ].map(({ Icon, href, label }) => (
                <a
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-3 border-t border-border/60 pt-6 text-xs text-muted-foreground sm:flex-row">
          <p>
            © {new Date().getFullYear()} Live Pet. Todos os direitos reservados.
          </p>
          <p className="inline-flex items-center gap-1.5">
            Feito com{" "}
            <Heart className="h-3.5 w-3.5 fill-primary text-primary" /> para o
            seu pet.
          </p>
        </div>
      </div>
