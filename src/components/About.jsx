      ...
      <div className="container relative z-10">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-base leading-relaxed text-muted-foreground sm:text-lg">
            Nascemos da ideia de que cada animal merece uma família que conheça
            sua história, sua saúde e sua linhagem. Unimos veterinários,
            criadores responsáveis e famílias em um só lugar — com tecnologia,
            transparência e muito carinho.
          </p>
        </div>
          ...
          <div className="relative lg:col-span-2">
            ...
            <div className="relative h-full rounded-[1.75rem] border border-border/60 bg-card/90 p-7 shadow-card backdrop-blur-xl">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Começamos pequenos, com a missão de combater o registro
                fraudulento de pedigrees e facilitar adoções responsáveis no
                Brasil.
              </p>
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Hoje somos uma comunidade que conecta tutores, veterinários e
                criadores em torno de um único propósito:{" "}
                <strong className="text-foreground">
                  vidas felizes, lares felizes
                </strong>
                .
              </p>
              <div className="mt-6 flex items-center gap-2 rounded-2xl border border-dashed border-primary/30 bg-primary-soft/50 p-3">
                ...
                <p className="text-xs font-medium text-foreground">
                  Selo de transparência reconhecido por entidades veterinárias
                  parceiras.
                </p>
              </div>
            </div>
