      ...
      <div className="container relative grid gap-12 py-20 lg:grid-cols-[1.1fr_1fr] lg:items-center lg:py-28">
        <div className="flex flex-col gap-7 animate-fade-up">
          ...
          <p className="max-w-lg text-base text-muted-foreground sm:text-lg">
            ...
            validação de pedigree, Cartão Animal com QR Code, carteira de
            vacinas, árvore genealógica, match e adoção responsável, além da
            rede de cuidados do seu pet.
          </p>
        ...
        <div
          className="relative mx-auto w-full max-w-md animate-fade-up lg:max-w-lg"
        ...
        >
          ...
          <div className="relative aspect-square">
            ...
            <Sparkles className="absolute right-2 bottom-12 z-10 h-5 w-5 text-accent-yellow animate-twinkle" />
